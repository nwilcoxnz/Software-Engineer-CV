  ...
  \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Web app}
         ...
         {\textit{Technologies used:} React.js, HTML, SCSS, webpack}
        \resumeItem{Automated customer verification tool}
          {Working to create a tool to verify the identity of HomeShare customers, subsequently pulling loan data from ASB to be served through the HomeShare platform.}
			{\textit{Technologies used: }C\# .NET API, SSMS, IIS }
...
\section{Personal Projects}
  ...
  \resumeSubHeadingListEnd
{\textit{Technologies used:} React.js, Python, CSS/HTML, webpack, npm, Cloudflare, Github Pages, AliExpress API integration, Google Analytics}
